...
<h2 align="center">A passionate Backend developer from India with a love for all things Golang, Linux, and open source. My coding journey often involves diving into the realms of C and C++, crafting efficient solutions. I thrive in the cloud, navigating AWS landscapes and orchestrating with Docker. When not in code, you'll find me scripting away in Bash or exploring the endless possibilities of cloud computing. Let's build something amazing together!</h2>
